"use server"; //all code will be executed on the server, not client browser
...
export async function createProfileAction(data: InsertProfile): Promise<ActionState> { //single argument data, type InsertProfile
  try {
